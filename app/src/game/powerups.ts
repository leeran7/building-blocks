 ...
 *
 * BALANCE. The hazard passes 1.0x climb speed at ~67s and holds at 1.15x, so an
 ...
 * power-up that can break that: held at 100% uptime it drops the lava to 0.29x
 * and the tower becomes survivable forever. Its cooldown is what keeps the
 * guarantee — it caps uptime at 6s in every 36s, so the lava still averages
 * 1.15 · (1 − 0.75 · 0.167) ≈ 1.006x the climb speed. That margin is thin on
