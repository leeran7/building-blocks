...
- Canonical human-facing investigation for launching The Climb on iOS and mobile alone: [`docs/ios-mobile-launch.md`](docs/ios-mobile-launch.md) (Safari + Home Screen, not App Store).
