...
**AC-SI-3.** Given canShare===true, when success runs, then shareVideoFile is invoked once automatically; if it returns aborted/error/unsupported due to missing gesture, success chrome remains with Share button (≥44×44).
